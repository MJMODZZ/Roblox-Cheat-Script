...
local themeStyles = {
    ...
    Cobalt = {
        SchemeColor = Color3.fromRGB(46, 51, 59),
        Background = Color3.fromRGB(19, 25, 35),
        Header = Color3.fromRGB(22, 28, 37),
        TextColor = Color3.fromRGB(200, 200, 200),
        ElementColor = Color3.fromRGB(22, 28, 37)
    },
    Midnight = {
